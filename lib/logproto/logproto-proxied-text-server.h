...
typedef struct _LogProtoProxiedTextServer
{
  ...
  gchar v1_proxy_header_buff[PROXY_PROTO_HDR_MAX_LEN_RFC];
...
LogProtoServer *log_proto_proxied_text_tls_server_new(LogTransport *transport, const LogProtoServerOptions *options);
