...
static GOptionEntry loggen_options[] =
{
  ...
  { "proxied-passthrough", 0, 0, G_OPTION_ARG_NONE, &global_plugin_option.proxied_passthrough, "Send the PROXY protocol v1 header before the encrypted payload", NULL },
